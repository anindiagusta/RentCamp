...
$query = "SELECT * FROM obatan WHERE idobatan='$_GET[id]'";
...
<div class="form">
      ...
      <div><h2>EDIT OBATAN</h2></div><br>
        ...
        <div class="text">
          <input type="file" name="foto" value="<?= $data['foto'] ?>" required><br>
        </div>
        <div class="input-box">
  ...
  if (isset($_POST['edit'])) {
    ...
    mysqli_query($conn, "UPDATE obatan SET nama='$nama', harga='$harga', foto='$foto', detail='$detail' WHERE idobatan='$_GET[id]'") or die(mysqli_error($conn));
