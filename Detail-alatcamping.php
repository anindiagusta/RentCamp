...
<html>
    <head>
        ...
        <title>DETAIL ALAT CAMPING PAGE</title>
    </head>
    <body>
    <section class="navbar">
      ...
      <?php
        include "connection.php";
        $no=1;
        $query = "SELECT * FROM alatcamping where idalat='$id'";
      ...
      <td>
        ...
        <button name="tambah"><p><a href="tambah.php?id=<?php echo $data['idalat'];?>">Tambah</a></p></button>
        <button><p><a href="video.html">Tutorial</a></p></button>
        </td>
      </table>
    <?php 
    }
