...
<html>
    ...
    <?php
      ...
      while($result = mysqli_fetch_array ($tampil)){
        ?>
      <div class="grid-item">
        <a href="Detail-alatcamping.php?id=<?php echo $result["idalat"];?>" style="text-decoration: none; color: black;">
        ...
        <center><button style="margin-bottom: 15px;"><p><a href="tambah.php?id=<?php echo $result["idalat"];?>">Tambah</a></p></button></center>
        </a>
      </div>
    <?php 
    $no++;
      ...
      <div style="margin-left:75px">
            ...
            <?php
                for ($i=1; $i<=$pages ; $i++){
            ?>
                <button><a href="alatcamping.php?halaman=<?php echo $i; ?>" style="text-decoration:none"><u><?php echo $i; ?></u></a></button>
            <?php
                }
            ?>
      </div>
